...
const StudentGradingSystem = () => {
  ...
  const getCurrentProgress = () => {
    ...
    const hasCollegeInfo =
      collegeName.trim() !== "" && collegeAddress.trim() !== "" &&
      collegePhone.trim() !== "" && collegeEmail.trim() !== "";
    return {
  ...
  const showMinimum = () => {
    const marks = subjects
      .filter(subject => subject.name.trim() !== "" && subject.mark > 0)
  ...
  const showMedian = () => {
    ...
    if (marks.length > 0) {
      ...
      if (marks.length % 2 === 0) {
        setMedian((marks[middle - 1] + marks[middle]) / 2);
      } else {
        setMedian(marks[middle]);
      }
    }
  };
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white/80 rounded-2xl shadow p-4 border border-white/50">
            ...
            <div className="grid grid-cols-3 gap-2 mt-3">
              <button
                onClick={showMinimum}
                className="bg-gradient-to-r from-green-500 to-emerald-600 text-white py-2 px-3 rounded hover:from-green-600 hover:to-emerald-700 shadow text-xs font-medium"
              >
                Show Minimum
              </button>
              <button
                onClick={showMaximum}
                className="bg-gradient-to-r from-orange-500 to-red-600 text-white py-2 px-3 rounded hover:from-orange-600 hover:to-red-700 shadow text-xs font-medium"
              >
                Show Maximum
              </button>
              <button
                onClick={showMedian}
                className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white py-2 px-3 rounded hover:from-purple-600 hover:to-indigo-700 shadow text-xs font-medium"
              >
                Show Median
              </button>
            </div>
              ...
              {totalMarks !== null && (
                <div className="bg-white/80 rounded-2xl shadow p-4 border border-white/50">
                  ...
                  <div className="space-y-3">
                    ...
                    {/* Statistics Display */}
                    {(minMark !== null || maxMark !== null || median !== null) && (
                      <div className="space-y-3">
                        {minMark !== null && (
                          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-3 border border-green-200">
                            <div className="text-center">
                              ...
                              <p className="text-xs text-green-600 mt-1">
                                Grade: {getGradeFromMarks(minMark)}
                              </p>
                            </div>
                          </div>
                        )}
                          ...
                          <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-3 border border-orange-200">
                            <div className="text-center">
                              ...
                              <p className="text-xs text-orange-600 mt-1">
                                Grade: {getGradeFromMarks(maxMark)}
                              </p>
                            </div>
                          </div>
                        )}
                          ...
                          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-3 border border-purple-200">
                            <div className="text-center">
                              ...
                              <p className="text-xs text-purple-600 mt-1">
                                Grade: {getGradeFromMarks(median)}
                              </p>
                            </div>
                          </div>
                        )}
              ...
              <div className="space-y-3">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-3 border border-purple-200">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div
                      className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                        progress.hasCollegeInfo
                          ? "bg-green-100 text-green-700"
                          : "bg-amber-100 text-amber-700"
                      }`}
                    >
                      {progress.hasCollegeInfo ? "Complete" : "Incomplete"}
                    </div>
                  </div>
                  <div className="text-xs text-slate-600">
                    {progress.hasCollegeInfo
                      ? "College details entered"
                      : "Please enter college info"}
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-4 border border-amber-200">
              ...
              <div className="space-y-2 text-xs text-amber-700">
                <div className="flex items-start gap-1">
                  ...
                  <div>Enter student & college details</div>
                </div>
                <div className="flex items-start gap-1">
                  <div className="w-5 h-5 bg-amber-200 rounded-full flex items-center justify-center text-amber-800 font-bold text-xs mt-[1.5px]">
                    2
                ...
                <div className="flex items-start gap-1">
                  ...
                  <div>Use min/max/median buttons</div>
                </div>
                <div className="flex items-start gap-1">
                  <div className="w-5 h-5 bg-amber-200 rounded-full flex items-center justify-center text-amber-800 font-bold text-xs mt-[1.5px]">
                    4
                  </div>
                  <div>Calculate for SGPA analysis</div>
                </div>
              </div>
            </div>
          </div>
